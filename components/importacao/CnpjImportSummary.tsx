...
/**
 * Tela de resumo pós-gravação da importação de "CNPJ em massa" (Fase 19,
 * IMP-03) — irmã estrutural de FrequenciaImportSummary.tsx: mesma grade de
 * dois cartões (bordas verde/âmbar, mesmos ícones), mesmo formatador de
 * inteiro, mesmo tamanho de exibição de 20px (`text-xl`) das duas
 * contagens. Copy e botões são deste fluxo (fala em CNPJ atualizado, não em
 * frequência).
 *
 ...
 */
export function CnpjImportSummary({
  atualizadosCount,
  puladas,
  onVerClientes,
  onEnviarOutra,
}: CnpjImportSummaryProps) {
