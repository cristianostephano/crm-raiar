...
INSTALL_JS_GLOBAL="C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
