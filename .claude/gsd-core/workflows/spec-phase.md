...
ones). Reference: @C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/Users/Cristiano/workspace/crm-raiar/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/Users/Cristiano/workspace/crm-raiar/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/templates/spec.md.
