...
Key references:
- @C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/references/ui-brand.md (display patterns)
- @C:/Users/Cristiano/workspace/crm-raiar/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/USER-PROFILE.md" "C:/Users/Cristiano/workspace/crm-raiar/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/references/user-profiling.md`
...
Reference: @C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to C:/Users/Cristiano/workspace/crm-raiar/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/Users/Cristiano/workspace/crm-raiar/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/Users/Cristiano/workspace/crm-raiar/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="C:/Users/Cristiano/workspace/crm-raiar/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/Users/Cristiano/workspace/crm-raiar/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        C:/Users/Cristiano/workspace/crm-raiar/.claude/CLAUDE.md
```
