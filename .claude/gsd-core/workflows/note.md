...
- **Global scope**: `C:/Users/Cristiano/workspace/crm-raiar/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Cristiano/workspace/crm-raiar/.claude/notes/`)
...
2. Glob `C:/Users/Cristiano/workspace/crm-raiar/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Cristiano/workspace/crm-raiar/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Cristiano/workspace/crm-raiar/.claude/notes/` — works in any directory
