...
```
Agent(
  prompt="Read C:/Users/Cristiano/workspace/crm-raiar/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/templates/VALIDATION.md`
