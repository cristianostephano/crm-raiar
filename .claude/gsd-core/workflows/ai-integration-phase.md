...
<required_reading>
@C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/references/ai-frameworks.md
@C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Users/Cristiano/workspace/crm-raiar/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Users/Cristiano/workspace/crm-raiar/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Users/Cristiano/workspace/crm-raiar/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Users/Cristiano/workspace/crm-raiar/.claude/agents/gsd-eval-planner.md for instructions.
