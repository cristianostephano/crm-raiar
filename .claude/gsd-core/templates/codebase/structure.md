...
- Usage: Reference from command with `@C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to C:/Users/Cristiano/workspace/crm-raiar/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/Cristiano/workspace/crm-raiar/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
