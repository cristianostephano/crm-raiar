...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/Cristiano/workspace/crm-raiar/.claude/.gsd-surface.json`
(sibling to `C:/Users/Cristiano/workspace/crm-raiar/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/Cristiano/workspace/crm-raiar/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Users/Cristiano/workspace/crm-raiar/.claude/skills`).
...
`C:/Users/Cristiano/workspace/crm-raiar/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/Cristiano/workspace/crm-raiar/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/Cristiano/workspace/crm-raiar/.claude/.gsd-surface.json`
Install profile marker: `C:/Users/Cristiano/workspace/crm-raiar/.claude/.gsd-profile`
Skill dirs: `C:/Users/Cristiano/workspace/crm-raiar/.claude/skills/gsd-*/`
Engine module: `C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
