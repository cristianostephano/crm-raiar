...
**Verification depth scales with `asvs_level`** (see @C:/Users/Cristiano/workspace/crm-raiar/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
